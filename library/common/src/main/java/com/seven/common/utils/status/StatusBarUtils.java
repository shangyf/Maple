package com.seven.common.utils.status;
...
import com.seven.common.utils.DensityUtil;
import com.seven.common.utils.DeviceUtils;
...
/**
 * Created by SeVen on 4/12/21 11:06 AM
 */
...
//            }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (DeviceUtils.isTablet(context)
                && sStatusbarHeight > DensityUtil.dip2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
    ...
    public static boolean isNavigationBarExist(Activity activity) {
        return DensityUtil.isNavigationBarExist(activity);
    }
}